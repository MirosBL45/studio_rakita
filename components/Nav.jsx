...
function Nav() {
  ...
  return (
    <nav className="flex flex-col items-center xl:justify-center gap-y-4 fixed bottom-0 mt-auto xl:right-[2%] z-50 t-0 w-full xl:w-16 xl:max-w-md xl:bottom-[30vh]">
      {/* inner */}
